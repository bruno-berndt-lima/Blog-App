        ...
        <div className="mt-8 flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-4">
                ...
                {posts[1] && <div className="lg:h-1/3 flex justify-between gap-4">
                    ...
                    <div className="w-2/3">
                        ...
                        <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                            ...
                            <span className="text-gray-500 text-sm">{posts[1].createdAt}</span>
                        </div>
                ...
                {posts[2] && <div className="lg:h-1/3 flex justify-between gap-4">
                    <div className="w-1/3 aspect-video">
                        {posts[2].img && <Image src={posts[2].img} className="rounded-3xl object-cover w-full h-full" w="298"/>}
                    </div>
                    ...
                    <div className="w-2/3">
                        ...
                        <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                            ...
                            <span className="text-gray-500 text-sm">{posts[2].createdAt}</span>
                        </div>
                ...
                {posts[3] && <div className="lg:h-1/3 flex justify-between gap-4">
                    <div className="w-1/3 aspect-video">
                        {posts[3].img && <Image src={posts[3].img} className="rounded-3xl object-cover w-full h-full" w="298"/>}
                    </div>
                    ...
                    <div className="w-2/3">
                        ...
                        <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                            ...
                            <span className="text-gray-500 text-sm">{posts[3].createdAt}</span>
                        </div>
